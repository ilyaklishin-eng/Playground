...
const HOME_COPY = {
  ...
  fr: {
    ...
    kf: "fondateur et strategiste.",
    volna: "cofondateur et redacteur en chef.",
    tvRain: "ancien responsable de la redaction numerique.",
    rtvi: "ancien directeur numerique.",
    referencesLabel: "References independantes",
    showAll: "Voir tout",
  },
  de: {
    proofLabel: "Berufliche Eckpunkte",
    kf: "Gruender und Stratege.",
    volna: "Mitgruender und Chefredakteur.",
    tvRain: "ehemaliger Leiter der digitalen Redaktion.",
    rtvi: "ehemaliger Digital Director.",
    referencesLabel: "Unabhaengige Referenzen",
    showAll: "Alles anzeigen",
  },
  es: {
    proofLabel: "Puntos profesionales clave",
    kf: "fundador y estratega.",
    volna: "cofundador y editor en jefe.",
    tvRain: "exjefe de redaccion digital.",
...
const MINIMAL_COPY = {
  ...
  fr: {
    label: "En bref",
    intro: "Les references independantes incluent",
  },
  de: {
    label: "Auf einen Blick",
    intro: "Unabhaengige Referenzen umfassen",
  },
  es: {
    label: "De un vistazo",
